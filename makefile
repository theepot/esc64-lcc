...
$Besc64$O:	$Besc64.c;	$(CC) $(CFLAGS) -c -Isrc -o $@ $Besc64.c
...
$Besc64.c:	$Blburg$E src/esc64.md; $Blburg src/esc64.md $@
...
clean::		testclean
		$(RM) $B*$O
		$(RM) $Bdagcheck.c $Balpha.c $Bmips.c $Bx86.c $Bsparc.c $Bx86linux.c $Besc64.c
